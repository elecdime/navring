...
-- 테이블 데이터 test.calendar:~5 rows (대략적) 내보내기
...
INSERT IGNORE INTO `calendar` (`ID`, `GROUPID`, `TITLE`, `WRITER`, `CONTENT`, `START1`, `END1`, `ALLDAY`, `TEXTCOLOR`, `BACKGROUNDCOLOR`, `BORDERCOLOR`, `USERNAME`, `LEADER_ID`, `CATECODE`, `CATEMAX`, `CATEMIN`, `userid`) VALUES
	...
	(40, NULL, 'ㄴㅁㄹ', '한다임/1,550.00/스카우터', 'ㅁㄴㄻㄹㅁㅇㄴㄹ', '2022-03-21 19:18:00', NULL, 1, 'yellow', 'navy', 'navy', NULL, 'asfsafas', '202', 8, 5, '267430837207826444'),
	(41, NULL, '346436', '한다임/1,550.00/스카우터', '346436', '2022-03-21 18:28:00', NULL, 1, 'yellow', 'navy', 'navy', NULL, '한다임/1,550.00/스카우터', '101', 100, 2, '267430837207826444'),
	(42, NULL, '4ㅅ5ㄱㄴㅇ홏', '한다임/1,550.00/스카우터', '', '2022-03-22 21:29:00', NULL, 1, 'yellow', 'navy', 'navy', NULL, '한다임3', '302', 8, -1, '267430837207826444');
...
INSERT IGNORE INTO `user` (`id`, `username`, `nickname`, `name`, `lv`, `role`, `last_tobal`, `issu`, `yellowCard`, `yellowCardWhy`, `real_tobal`, `sooncut`, `a`) VALUES
	('267430837207826444', '다임', '한다임/1,550.00/스카우터', '한다임', '1,550.00', '스카우터', '2022-03-21 18:28:00', '게임을 너무잘함', 1, '\r\n\r\n\r\n\r\n\r\n월루로 인한 경고1회 + 치킨혼자먹어서 경고1회', '2022-03-14 11:12:00', 'N', 1);
