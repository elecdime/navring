...
-- 테이블 데이터 test.calendar:~36 rows (대략적) 내보내기
...
INSERT IGNORE INTO `calendar` (`ID`, `GROUPID`, `TITLE`, `WRITER`, `CONTENT`, `START1`, `END1`, `ALLDAY`, `TEXTCOLOR`, `BACKGROUNDCOLOR`, `BORDERCOLOR`, `USERNAME`, `LEADER_ID`, `CATECODE`, `CATEMAX`, `CATEMIN`) VALUES
	...
	(4, NULL, '쿠쿠세이튼', 'test', '내용-content', '2022-03-07 00:00:00', '2022-03-07 00:00:00', 1, 'yellow', 'navy', 'navy', '1', '1', '203', NULL, 2),
	(5, NULL, '쿠쿠세이튼', 'test', '내용-content', '2022-03-07 08:00:00', '2022-03-07 00:00:00', 1, 'yellow', 'navy', 'navy', '1', '1', '203', NULL, 1),
	(6, NULL, '쿠쿠세이튼', 'test', '내용-content', '2022-03-07 12:00:00', '2022-03-07 00:00:00', 1, 'yellow', 'navy', 'navy', '0', '0', '203', 8, 4),
	(7, NULL, '토벌전', '한다임', '토벌전 갈사람', '2022-03-26 20:30:00', '2022-03-26 20:30:00', 1, 'yellow', 'navy', 'navy', NULL, '한다임', '101', 100, 2),
	(8, NULL, '토벌전', '한다임', '토벌전 갈사람', '2022-03-26 20:30:00', '2022-03-26 20:30:00', 1, 'yellow', 'navy', 'navy', NULL, '한다임', '101', 100, 2),
	(9, NULL, '토벌전', '한다임', '토벌전 갈사람', '2022-03-26 20:30:00', '2022-03-26 20:30:00', 1, 'yellow', 'navy', 'navy', NULL, '한다임', '101', 100, 3),
	(10, NULL, '토벌전', '한다임', '토벌전 갈사람', '2022-03-26 20:30:00', '2022-03-26 20:30:00', 1, 'yellow', 'navy', 'navy', NULL, '한다임', '101', 100, 3),
	(11, NULL, '토벌전', '한다임', '토벌전 갈사람', '2022-03-26 20:30:00', '2022-03-26 20:30:00', 1, 'yellow', 'navy', 'navy', NULL, '203', '101', 100, 2),
	...
	(23, NULL, 'ㅇ', '한다임', 'ㅇㄻㄴㄹ', '2022-03-16 22:30:00', '2020-03-16 22:30:00', 1, 'yellow', 'navy', 'navy', NULL, '한다임', '102', 16, 2),
	...
	(27, NULL, 'd', NULL, '뭐요&nbsp;', '2022-03-17 10:20:00', NULL, 1, 'yellow', 'navy', 'navy', NULL, NULL, '101', 100, 2),
	(28, NULL, '응애', '한다임/1,545.00/스카우터,한다임/1,545.00/스카우터', 'd', '2022-03-16 22:10:00', NULL, 1, 'yellow', 'navy', 'navy', NULL, NULL, '102', 16, 2),
	(29, NULL, 'ㅁㄴㄹㄴㅁㄹ', '한다임/1,548.33/스카우터,한다임/1,548.33/스카우터', 'ㅁㄴㄴ', '2022-03-17 04:21:00', NULL, 1, 'yellow', 'navy', 'navy', NULL, NULL, '101', 100, 2),
	(30, NULL, 'adaf', '한다임/1,548.33/스카우터,한다임/1,548.33/스카우터', 'asfsfz', '2022-03-18 11:17:00', NULL, 1, 'yellow', 'navy', 'navy', NULL, NULL, '102', 16, 2),
	(31, NULL, '금요일 발탄노말', '한다임/1,548.33/스카우터,한다임/1,548.33/스카우터', '발노 ㄱ', '2022-03-18 22:02:00', NULL, 1, 'yellow', 'navy', 'navy', NULL, NULL, '201', 8, 1),
	(32, NULL, '금요일 발탄노말', '한다임/1,548.33/스카우터', '발노 ㄱ', '2022-03-18 22:02:00', NULL, 1, 'yellow', 'navy', 'navy', NULL, NULL, '201', 8, 2),
	(33, NULL, '테스트', '한다임/1,548.33/스카우터,한다임/1,548.33/스카우터', 'ㅁㄴㄹ', '2022-03-18 11:59:00', NULL, 1, 'yellow', 'navy', 'navy', NULL, NULL, '202', 8, 1),
	(34, NULL, 'saf', '한다임/1,548.33/스카우터', 'saf', '2022-03-18 10:06:00', NULL, 1, 'yellow', 'navy', 'navy', NULL, '한다임/1,548.33/스카우터', '0', NULL, 1),
	(35, NULL, 'saf', '한다임/1,548.33/스카우터', 'saf', '2022-03-18 10:06:00', NULL, 1, 'yellow', 'navy', 'navy', NULL, '한다임/1,548.33/스카우터', '101', 100, 2),
	(36, NULL, 'asf', '한다임/1,548.33/스카우터', 'saff', '2022-03-18 01:12:00', NULL, 1, 'yellow', 'navy', 'navy', NULL, '=88', '101', 100, 2);
...
-- 테이블 데이터 test.rade:~53 rows (대략적) 내보내기
...
INSERT IGNORE INTO `rade` (`id`, `calid`, `nickname`) VALUES
	...
	(28, 6, '한다임'),
	(29, 6, '한다임'),
	(30, 6, '한다임/1,548.33/스카우터'),
	(31, 6, '한다임/1,548.33/스카우터'),
	(32, 6, '한다임/1,548.33/스카우터'),
	(33, 6, '한다임/1,548.33/스카우터'),
	(34, 6, '한다임/1,548.33/스카우터'),
	(35, 6, '한다임/1,548.33/스카우터'),
	(36, 6, '한다임/1,548.33/스카우터'),
	(37, 6, '한다임/1,548.33/스카우터'),
	(38, 5, '한다임/1,548.33/스카우터'),
	(39, 11, '한다임/1,548.33/스카우터'),
	(40, 10, '한다임/1,548.33/스카우터'),
	(41, 10, '한다임/1,548.33/스카우터'),
	(42, 9, '한다임/1,548.33/스카우터'),
	(43, 9, '한다임/1,548.33/스카우터'),
	(44, 27, '한다임/1,548.33/스카우터'),
	(45, 28, '한다임/1,548.33/스카우터'),
	(46, 29, '한다임/1,548.33/스카우터'),
	(47, 30, '한다임/1,548.33/스카우터'),
	(48, 23, '한다임/1,548.33/스카우터'),
	(49, 8, '한다임/1,548.33/스카우터'),
	(50, 7, '한다임/1,548.33/스카우터'),
	(51, 4, '한다임/1,548.33/스카우터'),
	(52, 32, '한다임/1,548.33/스카우터'),
	(53, 35, '한다임/1,548.33/스카우터'),
	(54, 36, '한다임/1,548.33/스카우터');
...
INSERT IGNORE INTO `user` (`id`, `username`, `nickname`, `name`, `lv`, `role`, `last_tobal`, `issu`, `yellowCard`, `yellowCardWhy`, `real_tobal`, `sooncut`) VALUES
	('267430837207826444', '다임', '한다임/1,548.33/스카우터', '한다임', '1,548.33', '스카우터', '2022-03-18 11:12:00', '게임을 너무잘함', 1, '월루로 인한 경고1회', '2022-03-14 11:12:00', 'n');
